...
10. **Open the File browser.** The Home page shows a red **"invalid configuration"** warning — this is **expected**, the board has firmware but no config yet. Click **File browser** in the left sidebar.
